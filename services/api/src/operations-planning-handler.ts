import type { OperationsPlanningDependencies } from "./types.js";
import { bearerToken, json } from "./http.js";

export async function operationsPlanningHandler(
  request: Request,
  dependencies: OperationsPlanningDependencies,
): Promise<Response> {
  ...
  return json(200, await dependencies.planning.getOperationsPlanning(actor), traceId);
}
