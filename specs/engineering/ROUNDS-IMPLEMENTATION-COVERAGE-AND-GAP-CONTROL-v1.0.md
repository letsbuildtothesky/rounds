...
| Driver · all currently authorized own-fleet depth | 49.4% (`38.0 / 77`) | gate incomplete | approximately 30% of the complete Driver V1 board set; roadmap estimate only |
...
| Combined authorized English own-fleet work | 58.4% (`75.90 / 130`) | **not release-ready** | approximately 20–25% of Slices 1–7; roadmap estimate only |
