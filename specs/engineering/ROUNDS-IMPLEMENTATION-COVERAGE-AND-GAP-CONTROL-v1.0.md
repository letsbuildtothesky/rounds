...
|---|---:|---:|---:|
| Driver · English Pilot business path only | 66.3% (`33.8 / 51`) | gate incomplete | not comparable to the complete board set |
| Driver · all currently authorized own-fleet depth | 51.9% (`39.95 / 77`) | gate incomplete | approximately 30% of the complete Driver V1 board set; roadmap estimate only |
...
| Combined authorized English own-fleet work | 60.0% (`79.80 / 133`) | **not release-ready** | approximately 20–25% of Slices 1–7; roadmap estimate only |
