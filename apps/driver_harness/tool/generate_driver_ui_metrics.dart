...
String generateDriverUiMetrics(Map<String, dynamic> json) {
  ...
  final h01Staging = h01['staging'] as Map<String, dynamic>;
  final h01Sheet = h01['sheet'] as Map<String, dynamic>;
  final h01Voice = h01['voice'] as Map<String, dynamic>;
...
abstract final class DriverH01Metrics {
  ...
  static const double stagingGap = ${_double(h01Staging['gap'])};
  static const double stagingPaddingBottom = ${_double(h01Staging['paddingBottom'])};
  static const double stagingWidth = ${_double(h01Staging['width'])};
  static const double stagingHeight = ${_double(h01Staging['height'])};
  static const double stagingRadius = ${_double(h01Staging['radius'])};
  static const double stagingPadding = ${_double(h01Staging['padding'])};
  static const double stagingIconSize = ${_double(h01Staging['iconSize'])};
  static const double stagingIconRadius = ${_double(h01Staging['iconRadius'])};
  static const double stagingIconGlyphSize = ${_double(h01Staging['iconGlyphSize'])};
  static const double stagingCopyGap = ${_double(h01Staging['copyGap'])};
  static const double stagingRemoveSize = ${_double(h01Staging['removeSize'])};
  static const double stagingTitleSize = ${_double(h01Staging['titleSize'])};
  static const double stagingDetailGap = ${_double(h01Staging['detailGap'])};
  static const double stagingDetailSize = ${_double(h01Staging['detailSize'])};

  static const double sheetInset = ${_double(h01Sheet['inset'])};
  static const double sheetCompactInset = ${_double(h01Sheet['compactInset'])};
  static const double sheetPaddingTop = ${_double(h01Sheet['paddingTop'])};
  static const double sheetPaddingHorizontal = ${_double(h01Sheet['paddingHorizontal'])};
  static const double sheetCompactPaddingHorizontal = ${_double(h01Sheet['compactPaddingHorizontal'])};
  static const double sheetPaddingBottom = ${_double(h01Sheet['paddingBottom'])};
  static const double sheetVoicePaddingBottom = ${_double(h01Sheet['voicePaddingBottom'])};
  static const double sheetRadiusTop = ${_double(h01Sheet['radiusTop'])};
  static const double sheetRadiusBottom = ${_double(h01Sheet['radiusBottom'])};
  static const double sheetBorderWidth = ${_double(h01Sheet['borderWidth'])};
  static const double sheetHandleWidth = ${_double(h01Sheet['handleWidth'])};
  static const double sheetHandleHeight = ${_double(h01Sheet['handleHeight'])};
  static const double sheetHandleTop = ${_double(h01Sheet['handleTop'])};
  static const double sheetHandleBottom = ${_double(h01Sheet['handleBottom'])};
  static const double sheetHeadPaddingHorizontal = ${_double(h01Sheet['headPaddingHorizontal'])};
  static const double sheetHeadPaddingTop = ${_double(h01Sheet['headPaddingTop'])};
  static const double sheetHeadPaddingBottom = ${_double(h01Sheet['headPaddingBottom'])};
  static const double sheetTitleSize = ${_double(h01Sheet['titleSize'])};
  static const double sheetRowMinHeight = ${_double(h01Sheet['rowMinHeight'])};
  static const double sheetRowPaddingHorizontal = ${_double(h01Sheet['rowPaddingHorizontal'])};
  static const double sheetRowIconColumn = ${_double(h01Sheet['rowIconColumn'])};
  static const double sheetRowIconSize = ${_double(h01Sheet['rowIconSize'])};
  static const double sheetRowGap = ${_double(h01Sheet['rowGap'])};
  static const double sheetRowArrowColumn = ${_double(h01Sheet['rowArrowColumn'])};
  static const double sheetRowArrowSize = ${_double(h01Sheet['rowArrowSize'])};
  static const double sheetRowTitleSize = ${_double(h01Sheet['rowTitleSize'])};

  static const double voiceStatePaddingHorizontal = ${_double(h01Voice['statePaddingHorizontal'])};
  static const double voiceStatePaddingVertical = ${_double(h01Voice['statePaddingVertical'])};
  static const double voiceKickerGap = ${_double(h01Voice['kickerGap'])};
  static const double voiceKickerDotSize = ${_double(h01Voice['kickerDotSize'])};
  static const double voiceKickerSize = ${_double(h01Voice['kickerSize'])};
  static const double voiceKickerTracking = ${_double(h01Voice['kickerTracking'])};
  static const double voiceTitleTop = ${_double(h01Voice['titleTop'])};
  static const double voiceTitleSize = ${_double(h01Voice['titleSize'])};
  static const double voiceTitleHeight = ${_double(h01Voice['titleHeight'])};
  static const double voiceTitleTracking = ${_double(h01Voice['titleTracking'])};
  static const double voiceTimeTop = ${_double(h01Voice['timeTop'])};
  static const double voiceTimeSize = ${_double(h01Voice['timeSize'])};
  static const double voiceTimeHeight = ${_double(h01Voice['timeHeight'])};
  static const double voiceTimeTracking = ${_double(h01Voice['timeTracking'])};
  static const double voiceWaveTop = ${_double(h01Voice['waveTop'])};
  static const double voiceWaveHeight = ${_double(h01Voice['waveHeight'])};
  static const double voiceWaveGap = ${_double(h01Voice['waveGap'])};
  static const double voiceWaveBarWidth = ${_double(h01Voice['waveBarWidth'])};
  static const double voiceWaveBarRadius = ${_double(h01Voice['waveBarRadius'])};
  static const double voiceActionsTop = ${_double(h01Voice['actionsTop'])};
  static const double voicePrimaryHeight = ${_double(h01Voice['primaryHeight'])};
  static const double voicePrimaryRadius = ${_double(h01Voice['primaryRadius'])};
  static const double voicePrimarySize = ${_double(h01Voice['primarySize'])};
  static const double voiceSecondaryHeight = ${_double(h01Voice['secondaryHeight'])};
  static const double voiceSecondaryTop = ${_double(h01Voice['secondaryTop'])};
  static const double voiceSecondarySize = ${_double(h01Voice['secondarySize'])};
  static const double voicePreviewTop = ${_double(h01Voice['previewTop'])};
  static const double voicePreviewPaddingVertical = ${_double(h01Voice['previewPaddingVertical'])};
  static const double voicePreviewGap = ${_double(h01Voice['previewGap'])};
  static const double voicePreviewPlaySize = ${_double(h01Voice['previewPlaySize'])};
  static const double voicePreviewPlayRadius = ${_double(h01Voice['previewPlayRadius'])};
  static const double voicePreviewIconSize = ${_double(h01Voice['previewIconSize'])};
  static const double voicePreviewTitleSize = ${_double(h01Voice['previewTitleSize'])};
  static const double voicePreviewDetailTop = ${_double(h01Voice['previewDetailTop'])};
  static const double voicePreviewDetailSize = ${_double(h01Voice['previewDetailSize'])};
