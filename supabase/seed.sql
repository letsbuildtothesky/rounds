...
values (
  ...
  'manual',
  'UF-DEMO-001',
  encode(extensions.digest('UF-DEMO-001-v1', 'sha256'), 'hex'),
  current_date,
  'Asia/Bangkok',
  '00000000-0000-4000-8000-000000000020',
  true,
  ...
  extensions.st_setsrid(extensions.st_makepoint(100.5470::double precision, 13.7439::double precision), 4326)::extensions.geography,
  'dispatcher_pin',
  'Hotel reception',
